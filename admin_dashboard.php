				...
				while ($row = mysqli_fetch_assoc($query_run)) 
				{
					...
					<h4><b><u>Teacher's details</u></b></h4><br><br>
						...
						<tr>
							...
							<td>
								<input type="text" name="teacher_subject" value="<?php echo $row['teacher_subject']?>">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" name="class_teacher" value="<?php echo $row['class_teacher']?>">
							</td>
						</tr>
						<tr>
							<td>
			...
			if(isset($_POST['add_teacher'])){
				...
				<form action="add_teacher.php" method="post">
					...
					<tr>
						...
						<td>
							<input type="text" name="class_teacher" required>
						</td>
					</tr>
					<tr>
						<td>
